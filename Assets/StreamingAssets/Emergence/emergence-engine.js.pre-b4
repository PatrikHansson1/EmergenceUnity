...
function tickWorld(S){
  ...
  if(S.tick%YEAR===0)aggregateTick(S); // B2.2a: vilande tills T_AGG nås // ENGINE 2.1 (D-086): per-community knowledge census + local loss/rediscovery (yearly; pure readout)
