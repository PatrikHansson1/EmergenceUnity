...
namespace UpDraftArt.EditorTools
{
    ...
    {
        private const string PromptShownKey = "UpDraft_BlacksmithFree_PromptShown";
        private const string DismissedKey = "UpDraft_BlacksmithFree_Dismissed";
        private const string FirstPlacementTicksKey = "UpDraft_BlacksmithFree_FirstPlacementUtcTicks";
        private const string NextPromptTicksKey = "UpDraft_BlacksmithFree_NextPromptUtcTicks";
        ...
        private const string ReviewUrl = "https://assetstore.unity.com/packages/slug/371198";
        private const string FullPackUrl = "https://assetstore.unity.com/packages/3d/props/interior/stylized-blacksmith-props-pack-358750";
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Space(12);
            GUILayout.Label("Thanks for trying the Free Blacksmith Sampler!", titleStyle);
            ...
            GUILayout.Space(8);
            GUILayout.Label(
                "If you want more props in this style, you can also check out the full Blacksmith Props Pack below.",
                bodyStyle);
