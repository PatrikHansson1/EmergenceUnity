...
namespace Emergence.Runtime
{
    public sealed class EmergenceJintHost
    {
        ...
        public const string ExpectedPresentationSha = "c72a612136d23c1e7e7e3df8e5e299ea9f145bb8391828cc54d1c3b716b3357d"; // P1 v0.7 (D-704/D-731/D-735, 2026-09-05, autonom; approved by Patrik 4 sep — TEXTPAKET path C): four render fixes for the read-aloud findings, digest+unit-proven on the v21 twin (exactly ONE intended line diff across 3 seeds x 150y): F11 possessive+article stripped ("Ask's the sail" -> "Ask's sail"); F12 late-loss line honest when (lostYear - deathYear) > 1 ("The last who knew X, <name>, is long gone — …"); F13 founder double epithet joined with comma ("Ask the First, the Firebringer"); F14/F9 leader re-election gets "listen again when …". Generated reproducibly by Reports/rig/p1/pending-v07/mkv07.py — identical bytes cloud and device. Backup: Reports/rig/p1/backup-v06/. Prior sha (v0.5): 1c7ba2da... // P1 v0.6 (D-648/D-656, 2026-09-01): tagFor uses the by-tag instead of a /144 division ("(born 0)" gone -> "of Stenholm"), SENTENCES{legend:2,customLost:2}, weightOf knowledgeLost scoped 20 (village-level while the tech lives) / 45 (world-level). P1-goldens on engine v20: 97013 460e621f / 4242 99e2a8fb / 20260718 699a93fa (Reports/rig/p1/pending-v06/p1-goldens-v06-on-v20.json). Prior sha (v0.5): 1c7ba2da... // emergence-presentation.js v0.5 (D-626/D-632: WEIGHT keyed to the engine's real 48 ev-types; P1-goldens on 8907f6f6). Prior: 38ffc100… (v0.4) // v0.4 (D-615/D-619: aggregate mask removed — engine v18 lines are English; P1-goldens on d02bb1ee). Prior: 3b1c7134… (v0.3) // v0.3 (D-613: actor spread; P1-goldens Reports/rig/p1/p1-goldens.json). Prior: 22438a87… (v0.2)
